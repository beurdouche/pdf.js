...
"""Generate the Signature Properties test-PDF corpus.
...
page says against what the Signature Properties doorhanger renders.
...
class PdfBuilder:
    ...
    def build(self):
        ...
        sig_prefix = (
            ...
            b"/Reason (Test signature for pdf.js Signature Properties UI) "
...
PAGE_HEADER = """\
Signature Properties — pdf.js test corpus
=========================================
